...
const Home = () => {
  ...
  const fetchingProducts = async () => {
    try {
      const res = await fetch("http://localhost:50000/products", {
        method: "GET",
        headers: {
          Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2OTcwMDNmOTI3OTA4NTI4YjUzYTkzNDgiLCJ1c2VybmFtZSI6Ik51ZXZvIHVzdWFyaW8iLCJlbWFpbCI6Im1hcmlhbm9AZ21haWwuY29tIiwiaWF0IjoxNzY5NzMxODk3LCJleHAiOjE3Njk3MzE5NTd9.aq22x-Ae76GGL-gal9zncdrs8oeibitobxhHgHqbAjw"
        }
      })
  ...
  const handleSubmit = async (e) => {
    ...
    if (!editingProduct) {
      ...
      const res = await fetch(`http://localhost:50000/products/${editingProduct._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2OTcwMDNmOTI3OTA4NTI4YjUzYTkzNDgiLCJ1c2VybmFtZSI6Ik51ZXZvIHVzdWFyaW8iLCJlbWFpbCI6Im1hcmlhbm9AZ21haWwuY29tIiwiaWF0IjoxNzY5NzI2MjE1LCJleHAiOjE3Njk3NjIyMTV9.sFyNW6qMEBnOaIIS2Nlkb5OmO0UKVAV8ELr2BKWD4GU"
  ...
  const handleDelete = async (id) => {
    ...
    if (validateDelete.isConfirmed) {
      await fetch(`http://localhost:50000/products/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: " Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2OTcwMDNmOTI3OTA4NTI4YjUzYTkzNDgiLCJ1c2VybmFtZSI6Ik51ZXZvIHVzdWFyaW8iLCJlbWFpbCI6Im1hcmlhbm9AZ21haWwuY29tIiwiaWF0IjoxNzY5NzI2MjE1LCJleHAiOjE3Njk3NjIyMTV9.sFyNW6qMEBnOaIIS2Nlkb5OmO0UKVAV8ELr2BKWD4GU"
        }
